...
// Chrome MCP 로 확인·수정까지 완료(2026-07-28). 알림설정 화면 Playwright 인프라 부재 (#28)
/**
 * 게시판 알림 정의 행 하단 확장 슬롯(notification_definition_row_footer) 위치 회귀 가드 (#28)
 *
 * @description
...
describe('게시판 알림 행 footer extension_point 위치 (#28)', () => {
